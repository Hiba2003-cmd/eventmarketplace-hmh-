...
export const AiEventPlannerPage = () => {
    ...
    <div className="min-h-screen p-6">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6 text-center">
          <h1 className="text-3xl font-bold text-gray-900 mb-2 text-[#260f80] ">
            <i className="pi pi-sparkles mr-3  text-[#260f80]"></i>
            AI Event Planner
          </h1>
  ...
  border: '1px solid rgba(255, 255, 255, 0.4)'
          ...
          <Button
            ...
            style={{ 
    backgroundColor: '#260f80', // لون الخلفية
    borderColor: '#260f80',     // لون الإطار
    borderRadius: '50px'        // ليكون بيضاوياً كما طلبك السابق
  }}
          />
        </Card>
